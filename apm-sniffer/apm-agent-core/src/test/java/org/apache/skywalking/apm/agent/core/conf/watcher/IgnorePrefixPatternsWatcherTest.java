...
public class IgnorePrefixPatternsWatcherTest {
    ...
    public void testConfigModifyEvent() {
        IgnorePrefixPatternsWatcher ignorePrefixPatternsWatcher = Whitebox.getInternalState(contextManagerExtendService
            , "ignorePrefixPatternsWatcher");
        ignorePrefixPatternsWatcher.notify(new AgentConfigChangeWatcher.ConfigChangeEvent(
            ".txt,.log",
            AgentConfigChangeWatcher.EventType.MODIFY
        ));
        Assert.assertEquals(".txt,.log", ignorePrefixPatternsWatcher.getIgnorePrefixPatterns());
        Assert.assertEquals("agent.ignore_prefix", ignorePrefixPatternsWatcher.getPropertyKey());
    }
